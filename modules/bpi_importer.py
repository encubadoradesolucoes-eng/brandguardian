...
class BPIImporter:
    ...
    def update_context(self, text):
        ...
        if "concessões" in text_lower or "concedidos" in text_lower or "publicados" in text_lower:
            ...
            if "provisórias" in text_lower:
                 self.current_context['status'] = 'recusa_provisoria'
            elif "definitivas" in text_lower:
                 self.current_context['status'] = 'recusa_definitiva'
            else:
                 self.current_context['status'] = 'recusa'
        
        elif "regional" in text_lower or "internacional" in text_lower:
            self.current_context['status'] = 'pedido_regional'
            self.current_context['format'] = 'tabela'
